...
{
    public class GoogleImageSearcher : IGoogleImageSearcher
    {
        private readonly HttpClient _httpClient;
        private readonly GoogleSearchOptions _options;

        public GoogleImageSearcher(HttpClient httpClient, GoogleSearchOptions options)
        {
        ...
        {
            var url = $"https://www.googleapis.com/customsearch/v1?q={Uri.EscapeDataString(query)}&cx={_options.SearchEngineId}&key={_options.ApiKey}&searchType=image&num={count}";
